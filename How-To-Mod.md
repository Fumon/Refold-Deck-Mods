...
1. Tap the three dot icon in the upper right ![AD1](res/AD1.png)
2. Select "Manage note types" ![AD2](res/AD2.png)
3. Scroll down until you find "Japanese Recognition". Press and hold the entry until a box pops up ![AD3](res/AD3.png)
4. Select "Edit cards" ![AD4](res/AD4.png)
5. You should now see a screen that looks similar to this. The three separate areas you can edit are highlighted ![AD5](res/AD5.png)
...
6. Once you are finished, you can preview (the eye) or finish and save (checkmark) using the controls in the top right.